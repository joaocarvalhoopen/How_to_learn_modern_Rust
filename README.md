...
36. **Engineering Rust Web Applications - Book** <br>
    [https://erwabook.com/](https://erwabook.com/)

37. **Programming Rust: Fast, Safe Systems Development 2nd Ed** <br>
    by Jim Blandy, Jason Orendorff

38. **Rust for Rustaceans: Idiomatic Programming for Experienced Developers** <br>
    by Jon Gjengset

39. **Refactoring to Rust** <br>
    by Lily Mara

40. **Practical System Programming for Rust Developers** <br>
    Build fast and secure software for Linux/Unix systems with the help of practical examples <br>
    by Prabhu Eshwarla

41. **Hands-On Concurrency with Rust**: Confidently build memory-safe, parallel, and efficient software in Rust <br>
    by Brian L. Troutwine 

42. **GDB: The GNU Project Debugger** <br>
    [https://www.gnu.org/software/gdb/documentation/](https://www.gnu.org/software/gdb/documentation/)

43. **The LLDB Debugger** <br>
    [https://lldb.llvm.org/](https://lldb.llvm.org/)

44. **Valgrind User Manual** <br>
    [https://valgrind.org/docs/manual/manual.html](https://valgrind.org/docs/manual/manual.html)

45. **The perf Linux profiler - Examples of use** <br>
    [https://www.brendangregg.com/perf.html](https://www.brendangregg.com/perf.html)

46. **QuickCheck - QuickCheck is a way to do property based testing using randomly generated input.** <br>
    [https://github.com/BurntSushi/quickcheck](https://github.com/BurntSushi/quickcheck)

47. **American Fuzzy Lop - A good fuzzer** <br>
    [https://lcamtuf.coredump.cx/afl/](https://lcamtuf.coredump.cx/afl/)

48. **Criterion rs - Statistics-driven Microbenchmarking in Rust** <br>
    [https://github.com/bheisler/criterion.rs](https://github.com/bheisler/criterion.rs)

49. **The Complete Rust Programming Reference Guide**: Design, develop, and deploy effective software systems using the advanced constructs of Rust <br>
	 by Rahul Sharma, Vesa Kaihlavirta 

50. **Creative Projects for Rust Programmers**: Build exciting projects on domains such as web apps, WebAssembly, games, and parsing <br>
    by Carlo Milanesi

51. **Rust High Performance**: Learn to skyrocket the performance of your Rust applications <br>
    by Iban Eguia Moraza 

52. **Writing an OS in Rust Philipp Oppermann's blog** <br>
    [https://os.phil-opp.com/](https://os.phil-opp.com/)

53. **The Rust Unstable Book** <br>
